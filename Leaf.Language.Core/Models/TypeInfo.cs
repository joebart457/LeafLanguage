...
public class TypeInfo
{
    ...
    public virtual int GetFieldOffset(Token fieldName) => throw new ParsingException(fieldName, $"type is not a struct type and does not contain any members");
    public virtual TypeInfo GetFieldType(Token fieldName) => throw new ParsingException(fieldName, $"type is not a struct type and does not contain any members");
